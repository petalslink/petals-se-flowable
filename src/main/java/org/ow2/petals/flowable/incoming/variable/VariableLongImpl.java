...
/**
 * Variable implementation for type {@code long}.
 * 
 * @author Christophe DENEUX - Linagora
 *
 */
public class VariableLongImpl extends VariableStringBasedValueImpl {

    public VariableLongImpl(final String name, final XPathExpression xpathExprValue, final String type,
