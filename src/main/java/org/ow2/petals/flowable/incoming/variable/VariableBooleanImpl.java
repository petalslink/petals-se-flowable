 ...
 *
 */
public class VariableBooleanImpl extends VariableStringBasedValueImpl {

    public VariableBooleanImpl(final String name, final XPathExpression xpathExprValue, final String type,
