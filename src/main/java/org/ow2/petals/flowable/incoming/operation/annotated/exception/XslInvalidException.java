...
/**
 * The XSL style-sheet is invalid (not buildable).
 * 
...
public class XslInvalidException extends InvalidAnnotationForOperationException {
    ...
    public XslInvalidException(final QName wsdlOperation, final String variableName, final String xslFilename,
            final Throwable cause) {
        super(wsdlOperation, String.format(MESSAGE_PATTERN, xslFilename, variableName), cause);
    }
