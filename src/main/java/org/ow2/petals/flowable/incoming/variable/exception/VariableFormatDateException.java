...
public class VariableFormatDateException extends VariableException {
    ...
    public VariableFormatDateException(final String variableName, final String variableValue, final Throwable cause) {
        super(String.format(MESSAGE_PATTERN, variableName, variableValue), cause);
    }
