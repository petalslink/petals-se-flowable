...
public class PlaceholdersProcessTest extends PlaceholdersProcessTestEnvironment {
    ...
    /**
     * <p>
     * Check the message processing where: a valid request is sent to process using deprecated placeholders correctly
     * defined
     * </p>
     * <p>
     * Expected results:
    ...
    public void deprecated() throws Exception {
        ...
        final StringBuilder processInstance = new StringBuilder();
        {
            ...
            final RequestToProviderMessage request = new RequestToProviderMessage(COMPONENT_UNDER_TEST, PLACEHOLDERS_SU,
                    DEPRECATED_OPERATION_START, AbsItfOperation.MEPPatternConstants.IN_OUT.value(), toByteArray(start));
        ...
        this.assertProcessInstancePending(processInstance.toString(), DEPRECATED_BPMN_PROCESS_DEFINITION_KEY);
        this.waitUserTaskAssignment(processInstance.toString(), DEPRECATED_USER_TASK_1, BPMN_USER);
...

        {
            ...
            final RequestToProviderMessage request = new RequestToProviderMessage(COMPONENT_UNDER_TEST, PLACEHOLDERS_SU,
                    DEPRECATED_OPERATION_UNLOCK, AbsItfOperation.MEPPatternConstants.IN_OUT.value(),
                    toByteArray(unlock));
