...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template match="/">
      <xsl:element name="start-response" namespace="http://petals.ow2.org/se-flowable/unit-test/intermediate-message-catch-event">
         <xsl:element name="case-file-number" namespace="http://petals.ow2.org/se-flowable/unit-test/intermediate-message-catch-event">
