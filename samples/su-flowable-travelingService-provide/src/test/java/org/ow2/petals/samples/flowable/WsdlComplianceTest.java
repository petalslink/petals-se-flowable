...
public class WsdlComplianceTest {
    ...
    public void validate() throws Exception {
        assertWsdlCompliance(
                new QName[] { new QName("http://petals.ow2.org/samples/se-flowable/traveling/travelingService", "new"),
                        new QName("http://petals.ow2.org/samples/se-flowable/traveling/travelingService",
                                "validate") });
    }
